...
/***/ function(module, exports) {
	...
	// 				<button @click="repost" class="btn btn-primary btn-lg" ID="resend" role="button" HREF="javaScript:void(0);">
	// 				重新发送激活邮件
	// 				</button>
	// 			</div>
	// 		</div>	
	...
	// 					<p style="font:16px;">邮件已发送！请点击邮箱(<a href={{loginname}}>{{loginname}}</a>)中的链接完成账号激活！</p>
	// 			</div>
	// 		</div>
	// 	</div>
	//
