...
$(document).ready(function(){
    ...
    //
    // ZeroClipboard.config( { swfPath: '/plugin/zero/ZeroClipboard.swf' } );
            ...
            success:function(json){
                ...
                if(allrepnum!=0){
                    ...
                    for(var i=0;i<len;i++){
                        ...
                        //console.log('json.data.results[i].supply_style:',json.data.results[i].supply_style);

                        if(json.data.results[i].supply_style=="api"){
                            //console.log('true')
                            var getKeyBtn="<btton class='getAPIkey'  data-toggle='modal' data-target='.getKey'>获取APIKEY</btton>";
                        }else{
                            var getKeyBtn='';
                        }
                        ...
                        $("#terminal-content-body").append(""+
                            ...
                            "<div class='order'>"+
                            "<div class='orderNum'>"+
                            "<p>订单号：<span>"+json.data.results[i].subscriptionid+"</span>" +
                            getKeyBtn+"</p>"+
                            "</div>"+
                            "<div class='orderTime'>"+
                ...
                //D:/localrepo/datahub_web_new/public/plugin/zero/ZeroClipboard.swf
                //ZeroClipboard.config( { swfPath: '/public/plugin/zero/ZeroClipboard.swf' } )
                ////var clip = new ZeroClipboard( document.getElementById("apiKeyCopy") );
                //var clip = new ZeroClipboard( document.getElementById("copy") );
                //var client = new ZeroClipboard($('.apiKeyCopy>button'));
