...
function repInfo(data){
  var reponame=data.reponame;
    ...
    var html = '<div class="listBox">' +
        ...
        '<a target="_blank" title="'+isitemdet+'/'+searchrepname+'" href="/'+isitemdet+'/'+searchrepname+'">中文/中文</a>' +
        thispricestate+
        '</div>' +
        '<div class="listNameTitle enTitle">' +
        '<a target="_blank" title="'+isitemdet+'/'+searchrepname+'" href="/'+isitemdet+'/'+searchrepname+'">name/name</a>' +
        '</div>' +
        '<div class="listLabel">' +
        datalabel+
        '</div>'+
        '<div class="listComment">' + ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd + '</div>' +
    ...
    */
    ...
    $($aboutBox).append('<div class="about">'+
        '<p class="aboutrep">中文名</p>'+
        '<p class="aboutrep">'+reponame+'</p>'+
